...
var this_js_script = jQuery('script[src*=gerencianet-checkout]'); // or better regexp to get the file name..

var billetActive = this_js_script.attr('data-billet_active');   
if (typeof billetActive === "undefined" ) {
   var billetActive = '1';
}

var cardActive = this_js_script.attr('data-card_active');   
if (typeof cardActive === "undefined" ) {
   var cardActive = '1';
}

var payee_code = this_js_script.attr('data-payee_code');   
if (typeof payee_code === "undefined" ) {
   var payee_code = 'error';
}

var shop_url = this_js_script.attr('data-shop_url');   
if (typeof shop_url === "undefined" ) {
   var shop_url = 'error';
}
...
jQuery(document).ready(function($){
    ...
    function createCharge(paymentType) {
        ...
        var order_id = jQuery("#order_number").val();
        var data = {
